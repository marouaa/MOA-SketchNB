...
public  class VNumNaiveSNBAdwinCLassLabel2 extends AbstractClassifier implements MultiClassClassifier {
	...
	public void trainOnInstanceImpl(Instance inst) {
		...
		this.observedClassSum +=inst.weight();
			...
			this.cmsketch.setString(updateS,inst.weight());
                ...
                //reset ?   
                    this.AdwinErr = new ADWIN();
                   // System.out.println(this.attributeObservers.toArray());
                    this.cmsketch = new CountMinSketch1(wid,depth);
