...
public class TestWidth extends AbstractClassifier implements MultiClassClassifier {
	...
	public void trainOnInstanceImpl(Instance inst) {
		...
		if (start == true) {
			...
			this.cmsketch = new CountMinSketch1(this.wid.getValue(),(int)Math.log(1/(1.0-
                        ...
                        System.out.println(this.cmsketch.getEpsilon());
                        System.out.println((Math.pow((double)(Math.exp(1.0)*this.NumAtt*this.streamsize.getValue()/this.wid.getValue())+1.0,this.NumAtt)-1.0)/(double)(this.NumAtt*this.streamsize.getValue()));
