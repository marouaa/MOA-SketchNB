 ...
 * @version $Revision: 7 $
 */
public class NaiveBayes1 extends AbstractClassifier  implements MultiClassClassifier {
    ...
    public void trainOnInstanceImpl(Instance inst) {
        ...
        for (int i = 0; i < inst.numAttributes() - 1; i++) {
            int instAttIndex = modelAttIndexToInstanceAttIndex(i, inst);
             ...
             GaussianNumericAttributeClassObserver obs = (GaussianNumericAttributeClassObserver) this.attributeObservers.get(i);
                        if (obs == null) {
                        obs = new GaussianNumericAttributeClassObserver();
                        this.attributeObservers.set(i, obs);
                        System.out.println(this.attributeObservers.get(i));
                        }
