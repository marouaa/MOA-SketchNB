...
public class CMNaiveBayesMultiSketch3 extends AbstractClassifier implements MultiClassClassifier {
	...
	public void trainOnInstanceImpl(Instance inst) {
		...
		if (start == true) {
			 ...
			 this.cmsketch = new CountMinSketch3[this.numClasses];
			 for (int i=0; i<this.numClasses; i++){
				this.cmsketch[i] = new CountMinSketch3((int) Math.ceil(Math.exp(1)/this.epsilonOption.getValue()),(int) Math.ceil(Math.log(1.0/this.deltaOption.getValue() )));
			 }
		}
